...
void OpcoesListaSequencial(Lista *listaSeq){
    ...
    switch(i){
        ...
        case 3:
            int f;
            cout << "1 para busca normal e 2 para busca binaria\n";
            cin >> f;
            switch (f){
                case 1:
                    ...
                    break;
                case 2:
                    buscaBinaria(listaSeq, listaSeq->numeroElementos);
                    break;
            }
        case 4:
        ...
        case 7:
            long long int z;
            cout << "Qual sort voce deseja? (1 para selection, 2 para insertion, 3 para bubble, 4 para shell, 5 para quick, 6 para merge)\n";
            cin >> z;
            switch (z){
                case 1:
                    selectionSort(listaSeq);
                    break;
                case 2:
                    insertionSort(listaSeq);
                    break;
                case 3:
                    bubbleSort(listaSeq, listaSeq->numeroElementos);
                    break;
                case 4:
                    shellSort(listaSeq, listaSeq->numeroElementos);
                    break;
                case 5:
                    if(listaSeq->numeroElementos !=0)
                        quickSort(listaSeq, 0, listaSeq->numeroElementos-1);
                    else
                        quickSort(listaSeq, 0, listaSeq->numeroElementos);
                    break;
                case 6:
                    if(listaSeq->numeroElementos !=0)
                        mergeSort(listaSeq, 0, listaSeq->numeroElementos-1);
                    else
                        mergeSort(listaSeq, 0, listaSeq->numeroElementos);
                    break;
                }
            }
        }
